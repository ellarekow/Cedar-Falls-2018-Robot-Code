...
Auto1ScaleRight::Auto1ScaleRight(double wait) {
	...
	AddSequential	(new CmdDrivePID(-188,-90, 1.0, Drive::encoderAverage, true, false, 5, false));		// Drive backward in front of platform
	...
	AddSequential	(new CmdRotatePID(89, 0.9, false, 3, false));										// Rotate toward Fence
	AddSequential	(new CmdDrivePID(-150, 89, 0.9, Drive::encoderAverage, true, false, 4, false));		// Drive backward in front of platform
