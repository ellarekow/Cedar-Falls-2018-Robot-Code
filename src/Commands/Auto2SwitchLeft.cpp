...
Auto2SwitchLeft::Auto2SwitchLeft(double wait) {
	...
	AddSequential	(new CmdDrivePID(-85, -23, 0.9, Drive::encoderAverage, true, false, 4, false));		// Back away from Switch
	...
	AddSequential	(new CmdRotatePID(2, 0.7, false, 2, false));										// Rotate toward Power Cube Zone
	AddSequential	(new CmdDrivePID(42, 2, 0.8, Drive::encoderAverage, true, false , 3, false));		// Drive to Zone
